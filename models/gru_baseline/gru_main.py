...
x = Bidirectional(LSTM(64, return_sequences=True, dropout=0.2, recurrent_dropout=0.1, kernel_regularizer=l1_l2(0.001, 0.01)))(x)
x = GlobalMaxPool1D()(x)
...
sample_submission.to_csv('C:/Users/okarnbla/Documents/private_repos/Kaggle/toxic_comment/submissions/LSTM_regularization64neuron_roc.csv', index=False)